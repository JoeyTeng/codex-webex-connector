...
- 详细历史、验证证据和迁移前 tracker 原文已移入 `docs/project_journal/`：
  ...
  - W8 C9 upgrade hook：`docs/project_journal/2026/06/2026-06-03-w8-c9-upgrade-hook-b2959bc.md`
...
- Next Steps:
  ...
  - 用同时支持 C8 PR #99 merge commit `ee76fdd5937ca57e8156631c32509be12d3cf4c2` 和 C9 PR #103 merge commit `87ebc8e3a39558daa5441c40d9bd8d7cffb3ca06` 的 `cbth` binary 执行 W9 live smoke；harness 会先运行 `cbth service upgrade-smoke`，再通过 C9 `plugin upgrade` 切换 Webex release B，并验证真实 Webex/cbth plugin-mode delivery smoke。
- Blockers:
